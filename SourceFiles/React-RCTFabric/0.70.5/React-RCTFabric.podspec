...
source = { :git => 'https://github.com/juspay/hyperswitch-pods.git' }
if version == '1000.0.0'
...
Pod::Spec.new do |s|
  ...
  s.source                 = source
  s.source_files           = "react-native/React/Fabric/*.{c,h,m,mm,S,cpp}", "react-native/React/Fabric/Mounting/*.{c,h,m,mm,S,cpp}", "react-native/React/Fabric/Surface/*.{c,h,m,mm,S,cpp}", "react-native/React/Fabric/Utils/*.{c,h,m,mm,S,cpp}"
  s.exclude_files          = "react-native/React/Fabric/tests/*",
                             "react-native/React/Fabric/android/*",
  s.compiler_flags         = folly_compiler_flags + ' ' + boost_compiler_flags
  s.header_dir             = "React"
  s.header_mappings_dir    = "react-native/React"
